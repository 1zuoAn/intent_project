...
class CacheService:
    ...
    async def _calibrate_time(self, current_query: str, agent_type: str, cached_params: Dict) -> Dict:
        ...
        instruction = ""
        if agent_type == "zhiyi": instruction = '请仅填充 startTime 和 endTime。'
        elif agent_type == "douyi": instruction = '请仅填充 dateRange。'
        elif agent_type == "abroad": instruction = '请仅填充 putOnSaleStartDate 和 putOnSaleEndDate。'
